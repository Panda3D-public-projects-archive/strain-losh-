...
class SceneGraph():
    ...
    def loadLevel(self, level):
        ...
        for i in xrange(0, level.maxX):
            ...
            tnp.setPos(i*utils.TILE_SIZE+1, -0.3, utils.GROUND_LEVEL)
            ...
            tnp.setColor(1, 1, 1)
            tnp.setScale(0.5, 0.5, 0.5)
            tnp.setPos(i*utils.TILE_SIZE+1, level.maxY*utils.TILE_SIZE+0.3, utils.GROUND_LEVEL)
            tnp.setBillboardPointEye()
            tnp.setLightOff()            
        for i in xrange(0, level.maxY):
            ...
            tnp.setColor(1, 1, 1)
            tnp.setScale(0.5, 0.5, 0.5)
            tnp.setPos(-0.3, i*utils.TILE_SIZE+1, utils.GROUND_LEVEL)
            tnp.setBillboardPointEye()
            tnp.setLightOff()
            t = TextNode('node name')
            t.setText( "%s" % i)
            ...
            tnp.setColor(1, 1, 1)
            tnp.setScale(0.5, 0.5, 0.5)
            tnp.setPos(level.maxX*utils.TILE_SIZE+0.3, i*utils.TILE_SIZE+1, utils.GROUND_LEVEL)
            tnp.setBillboardPointEye()
            tnp.setLightOff()                         
