...
class LevelListDataSource(DataSource): 
    def __init__(self, name): 
        ...
        self.levels = []
        self.levels.append({'name':'assasins', 'size':'20x20', 'players':2, 'description':'description0'})
        self.levels.append({'name':'assasins1', 'size':'21x20', 'players':2, 'description':'description1'})
        self.levels.append({'name':'assasins2', 'size':'22x20', 'players':2, 'description':'description2'})
        self.levels.append({'name':'assasins3', 'size':'23x20', 'players':2, 'description':'description3'})
        self.levels.append({'name':'assasins4', 'size':'24x20', 'players':2, 'description':'description4'})
        self.levels.append({'name':'assasins5', 'size':'25x20', 'players':4, 'description':'description5'})
        self.levels.append({'name':'assasins6', 'size':'26x20', 'players':4, 'description':'description6'})
        self.levels.append({'name':'assasins', 'size':'20x20', 'players':2, 'description':'description0'})
        self.levels.append({'name':'assasins1', 'size':'21x20', 'players':2, 'description':'description1'})
        self.levels.append({'name':'assasins2', 'size':'22x20', 'players':2, 'description':'description2'})
        self.levels.append({'name':'assasins3', 'size':'23x20', 'players':2, 'description':'description3'})
